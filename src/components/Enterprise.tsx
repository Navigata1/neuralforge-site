        ...
        >
          <div className="p-8 md:p-10">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <a
                href="#waitlist"
                className="rounded-full bg-[var(--color-accent)] px-6 py-3 text-center text-sm font-medium text-white transition-transform active:scale-[0.97] active:translate-y-[1px]"
              >
                Request enterprise demo
              </a>
              <a
                href="#waitlist"
                className="rounded-full border border-slate-200 px-6 py-3 text-center text-sm font-medium text-slate-700 transition-transform hover:border-slate-300 active:scale-[0.97] active:translate-y-[1px]"
              >
                Talk to sales
              </a>
            </div>
